...
struct SettingsView: View {
    ...
    init() {
        // We'll set the real manager in onAppear
        _viewModel = StateObject(wrappedValue: SettingsViewModel(manager: ScenarioManager()))
    }
    ...
    var body: some View {
        NavigationView {
            ...
            .onAppear {
                viewModel = SettingsViewModel(manager: manager)
            }
        }
    }
}
